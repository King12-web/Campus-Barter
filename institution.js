// Campus Swap - Nigerian institutions dataset (ALL tertiary institutions)
// Universities, polytechnics, colleges of education, monotechnics - 330 entries
// Bundled at build time, not fetched at runtime. To update: replace this file.
const INSTITUTIONS = [
 {
...
// Flat list of names - used for validation (typed value must exist here)
const INSTITUTION_NAMES = INSTITUTIONS.map(function (i) { return i.name; });